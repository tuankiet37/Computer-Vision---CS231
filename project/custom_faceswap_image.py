...
#############################################
    ...
    for triangle in triangles_array:
        ...
        line_color = (255,0,0)
        cv2.line(source_image, index_point1, index_point2, line_color, 1 )
        cv2.line(source_image, index_point2, index_point3, line_color, 1 )
        cv2.line(source_image, index_point3, index_point1, line_color, 1 )
        
        cv2.imshow("5: Drawing all Delaunay triangles in source image ", source_image)
